defmodule Aube.Native do
  ...
  @nif_path (if File.dir?("../crates/aube-beam-nif") do
               "../crates/aube-beam-nif"
             else
               "crates/aube-beam-nif"
             end)
  ...
  @rustler_precompiled_opts Keyword.merge(
                              [
                                ...
                                path: @nif_path,
                                base_url:
                                  "https://github.com/charlieaten/aube/releases/download/v#{@version}",
  ...
  def run_cli(_args), do: :erlang.nif_error(:nif_not_loaded)
